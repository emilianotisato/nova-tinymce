...
Nova.booting(function (Vue, router) {
    Vue.component('index-Nova-TinyMCE', __webpack_require__(3));
    Vue.component('detail-Nova-TinyMCE', __webpack_require__(6));
    Vue.component('form-Nova-TinyMCE', __webpack_require__(9));
});
